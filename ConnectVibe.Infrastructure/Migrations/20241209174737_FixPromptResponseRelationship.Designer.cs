...
namespace Fliq.Infrastructure.Migrations
{
    ...
    [Migration("20241209174737_FixPromptResponseRelationship")]
    partial class FixPromptResponseRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.AgeRange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.Event.Ticket", b =>
                {
                    ...
                    b.Property<string>("MaximumLimit")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.Prompts.PromptResponse", b =>
                {
                    ...
                    b.Property<int?>("PromptQuestionId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PromptQuestionId1")
                        .IsUnique()
                        .HasFilter("[PromptQuestionId1] IS NOT NULL");
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.Prompts.PromptResponse", b =>
                {
                    ...
                    b.HasOne("Fliq.Domain.Entities.Prompts.PromptQuestion", null)
                        .WithOne("PromptResponse")
                        .HasForeignKey("Fliq.Domain.Entities.Prompts.PromptResponse", "PromptQuestionId1");
