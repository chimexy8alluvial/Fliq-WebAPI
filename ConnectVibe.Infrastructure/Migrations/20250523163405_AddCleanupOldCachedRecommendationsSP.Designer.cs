...
namespace Fliq.Infrastructure.Migrations
{
    ...
    [Migration("20250523163405_AddCleanupOldCachedRecommendationsSP")]
    partial class AddCleanupOldCachedRecommendationsSP
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.AuditTrail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.BusinessIdentificationDocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BusinessIdentificationDocumentTypes");
                });
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.Profile.BusinessIdentificationDocument", b =>
                {
                    ...
                    b.Property<int>("BusinessIdentificationDocumentTypeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.Recommendations.CachedRecommendation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.Recommendations.UserInteraction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("InteractedWithUserId")
                        .HasColumnType("int");

                    b.Property<double>("InteractionStrength")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("InteractedWithUserId");
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.Subscriptions.SubscriptionPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.Subscriptions.SubscriptionPlanPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.Subscriptions.UserSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.Profile.BusinessIdentificationDocument", b =>
                {
                    b.HasOne("Fliq.Domain.Entities.BusinessIdentificationDocumentType", "BusinessIdentificationDocumentType")
                        .WithMany()
                        .HasForeignKey("BusinessIdentificationDocumentTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Fliq.Domain.Entities.Profile.UserProfile", "UserProfile")
                        .WithOne("BusinessIdentificationDocument")
                        .HasForeignKey("Fliq.Domain.Entities.Profile.BusinessIdentificationDocument", "UserProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.Recommendations.CachedRecommendation", b =>
                {
                    ...
                    b.HasOne("Fliq.Domain.Entities.User", "RecommendedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.Recommendations.UserInteraction", b =>
                {
                    ...
                    b.HasOne("Fliq.Domain.Entities.User", "InteractedWithUser")
                        .WithMany()
                        .HasForeignKey("InteractedWithUserId");
                    ...
                    b.Navigation("InteractedWithUser");
            ...
            modelBuilder.Entity("Fliq.Domain.Entities.Subscriptions.SubscriptionPlanPrice", b =>
                {
                    b.HasOne("Fliq.Domain.Entities.Subscriptions.SubscriptionPlan", "SubscriptionPlan")
                        .WithMany("Prices")
