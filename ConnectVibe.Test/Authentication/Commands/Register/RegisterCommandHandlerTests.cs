...
namespace Fliq.Test.Authentication.Commands.Register
{
    ...
    public class RegisterCommandHandlerTests
    {
        ...
        {
            // Arrange
            var command = new RegisterCommand("John", "Doe", "johndoe", "John Construction Ltd.", "Construction And Engineering", "20th Floor, Adeniyi Complex", "00000000000", "Anything Building", "johndoe@example.com", "password", Language.English, "Light", "23412345678");
